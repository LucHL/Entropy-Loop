...
public class AccessibilityManager : MonoBehaviour
{
    ...
    void LoadSettings()
    {
        ...
        BugTracker.Info($"[Accessibility] R�glages charg�s : daltonisme={ColorBlindMode}, police={FontScale}.");
    }
    ...
    public void ApplyColorBlindMode()
    {
        ...
        if (filter != null)
            ...
            BugTracker.Warning("[Accessibility] Aucun ColorBlindFilter trouv� sur la cam�ra principale.");
    }
}
